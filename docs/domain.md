...
| Catalogue / MRP maps | `catalogue-mrp.ts` | `catalogue-mrp.ts` actions | `/admin/catalogue` (Settings) |
| Deduct Ready materials | MRP `rp-deductions.ts` via `callMrpDeduct` | `deductMaterialsAction` | `/admin/catalogue` Ready tab |
